...
contract Exchange is ERC20 {
    ...
    /// @dev getReserve returns the balance of `token` held by `this` contract
    ...
    function addLiquidity(
        ...
        //console.log("tokenReserveBalance is %s",tokenReserveBalance);

        // If the reserve is empty, take any user supplied value for initial liquidity
        if (tokenReserveBalance == 0) {
            
            //console.log("tokenReserveBalance is zero");
            ...
            //console.log("lpTokens minted is %s",lpTokensToMint);
        ...
        //console.log("ethReserveBalance %s",ethReserveBalance);
    ...
    /// @dev ethToTokenSwap allows users to swap ETH for tokens
    ...
    /// @dev tokenToEthSwap allows users to swap tokens for ETH
